function signatureCapture() {
	...
	var bcanvas = document.getElementById("blank");
	var bcontext = canvas.getContext("2d");
	
	//var fontSize = 16;
	//var str = "Archie P. Amparo"
	...
	bcanvas.width = 350;
	bcanvas.height = 100;
	bcontext.fillStyle = "rgba(0,0,0,0)";
	bcontext.strokeStyle = "#444";
...
function saveImage() {
	...
	else
	{
	   ...
	   ajax.open('POST', 'save_sig.php', false);
